...
class InviteTripRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $trip
            ? ($this->user()?->can('manageMembers', $trip) ?? false)
            : false;
    }
    ...
    public function bodyParameters(): array
    {
        return [
            'email' => [
                'description' =>
                    'Email of the invited user. Must belong to an existing user. Cannot be your own email.',
            ...
            'message' => [
                'description' =>
                    'Optional message that will be included with the invitation. Max length: 255 characters.',
